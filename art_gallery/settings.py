...
INSTALLED_APPS = [
    ...
    'rest_framework',      # Professional API ke liye
    'corsheaders',         # Nickjs (Next.js) se connect karne ke liye
    'api',
]
...
# Agar default khali reh jata hai (Local machine par), toh engine manually set karein
...
# Settings.py mein DATABASES ke thoda niche
